<?php
    ...
    $query = mysqli_query($conn, "SELECT id_produto, nome, valor,estoque, model_address, cor FROM produtos JOIN carrinho ON produtos.id_produto = carrinho.id_carrinho");
